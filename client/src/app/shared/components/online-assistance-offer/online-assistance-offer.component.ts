...
export class OnlineAssistanceOfferComponent implements OnInit {
  ...
  handleFormSubmit(event) {
    ...
    this.EndpointService.createUser(payload).subscribe({
      next: (data: any) => {
        if (data) {
